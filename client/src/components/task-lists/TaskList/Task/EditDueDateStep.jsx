...
const EditDueDateStep = React.memo(({ taskId, onBack, onClose }) => {
  const selectTaskById = useMemo(() => selectors.makeSelectTaskById(), []);

  const defaultValue = useSelector((state) => selectTaskById(state, taskId).dueDate);
  ...
  const handleSubmit = useCallback(() => {
    ...
    onClose();
  }, [taskId, onClose, defaultValue, dispatch, t, data, dateFieldRef, timeFieldRef, nullableDate]);
  ...
  const handleClearClick = useCallback(() => {
    ...
    onClose();
  }, [taskId, onClose, defaultValue, dispatch]);
