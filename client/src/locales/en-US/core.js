...
export default {
  ...
  translation: {
    common: {
      ...
      createCardInList: 'Create card in list',
      ...
      startRepeatingAt: 'Start repeating at',
      ...
      userAssignedYouToTaskOnCard:
        '<0>{{user}}</0> assigned you to {{task}} on <2>{{card}}</2>',
      ...
      userCopiedCardFromCardToList:
        '<0>{{user}}</0> copied <2>{{card}}</2> from <4>{{sourceCard}}</4> to {{list}}',
      userCopiedThisCardFromCardToList:
        '<0>{{user}}</0> copied this card from <2>{{sourceCard}}</2> to {{list}}',
