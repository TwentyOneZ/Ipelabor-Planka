...
export default {
  ...
  translation: {
    common: {
      ...
      createCardInList: 'Criar cartão na lista',
      ...
      repeatCard_title: 'Repetir cartão',
      repeatEvery: 'Repetir',
      ...
      userCopiedCardFromCardToList:
        '<0>{{user}}</0> copiou <2>{{card}}</2> de <4>{{sourceCard}}</4> para {{list}}',
      userCopiedThisCardFromCardToList:
        '<0>{{user}}</0> copiou este cartão de <2>{{sourceCard}}</2> para {{list}}',
